...
function onSuccess(data, status) {
	...
	$(".delete").click(function (e) {
		...
		if (confirm("Are you sure you want to delete?")) {
			...
			fetch("https://gravel-rainbow-hammer.glitch.me/movies/" + $(this)[0].id.toString().slice(6, $(this)[0].id.length), {method: 'DELETE'}).then(function (response) {
...
$(document).ready(function() {
	...
	$.get("https://gravel-rainbow-hammer.glitch.me/movies")
		.done(onSuccess)
		.fail(onFail)
...
$("#addMovie").click(function(e) {
	...
	$("#addPoster").html("")
	$.post("https://gravel-rainbow-hammer.glitch.me/movies", movieObj).then(response => {
...
$('#saveChanges').click(function(e) {
	...
	fetch("https://gravel-rainbow-hammer.glitch.me/movies/" + $('#editID').val(), {method: 'PATCH', headers: {'Content-Type': 'application/json',}, body: JSON.stringify(movieObj),}).then(response => {
		console.log(response)
		$(this).disabled = false
...
$("#editCheckOMDB").click(function() {
	$("#searchResults").children().remove()
	fetch("https://api.themoviedb.org/3/search/movie?api_key=" + OMDB_API_KEY +"&language=en-US&query=" + $("#editTitle").val() + "&page=1&include_adult=false&year=" + $("#editYear").val()).then(data => data.json()).then(data => {
		...
		$("#searchResults").children().click(function() {
			...
			fetch("https://api.themoviedb.org/3/movie/" + $(this).attr("id") + "?api_key=" + OMDB_API_KEY + "&language=en-US").then(data => data.json()).then(data => {
				console.log(data)
				movieDetails = data
				$("#appendTrailers").children().remove()
			...
			fetch("https://api.themoviedb.org/3/movie/" + $(this).attr("id") + "/credits?api_key=" + OMDB_API_KEY + "&language=en-US").then(data => data.json()).then(data => {
				console.log(data);
...
$("#addCheckOMDB").click(function() {
	...
	fetch("https://api.themoviedb.org/3/search/movie?api_key=" + OMDB_API_KEY +"&language=en-US&query=" + $("#addTitle").val() + "&page=1&include_adult=false&year=" + $("#addYear").val()).then(data => data.json()).then(data => {
...
function getVideos(movieID,appendTo) {
	fetch("https://api.themoviedb.org/3/movie/" + movieID + "/videos?api_key=" + OMDB_API_KEY + "&language=en-US").then(data => data.json()).then(data => {
		console.log(data);
